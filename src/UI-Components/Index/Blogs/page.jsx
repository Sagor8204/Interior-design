              ...
              <div key={index} className="group cursor-pointer">
                <Link href={`/Ui-components/Blogs`}>
                  ...
                  <div className="blog-info mt-3">
                    ...
                    <h2 className="text-4xl md:text-5xl my-5 hover:text-(--prim) transition-all duration-300 CalSans">
                      {blog.title}
                    </h2>
                ...
                <Link href={`/Ui-components/Blogs`}>
                  <div className="flex flex-col lg:flex-row group cursor-pointer mb-5 gap-4">
                    ...
                    <div className="w-full lg:w-1/2 blog-info mt-3">
                      ...
                      <h2 className="text-3xl md:text-2xl my-3 hover:text-(--prim) transition-all duration-300 CalSans">
                        {blog.title}
                      </h2>
                      <p className="text-gray-500 GolosText">{blog.desc}</p>
                    </div>
