...
import BlogData from "@/JsonData/BlogsData.js";
            ...
            <div key={index} className="group cursor-pointer">
              <Link href={`/blogs/${blog.id}`}>
                <div className="blog-image relative rounded-2xl overflow-hidden">
                  ...
                  />
                  <span className="absolute hover:bg-(--text) top-5 left-5 bg-(--prim) px-4 py-1 font-semibold rounded-full text-white GolosText">
                    {blog.tag}
                  </span>
                </div>
                ...
                <div className="blog-info mt-3">
                  <p className="GolosText text-gray-400">
                    ...
                    <span className="text-(--prim) font-semibold">
                      {blog.postby} <span> - </span> {blog.date}
                    </span>
                  </p>
                  <h2 className="text-4xl md:text-3xl my-5 hover:text-(--prim) transition-all duration-300 CalSans">
                    {blog.title}
                  </h2>
